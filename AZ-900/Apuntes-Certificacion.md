...
* 2. [Temario](#Temario)
* 3. [Cómputo en la nube](#Cmputoenlanube)
	* 3.1. [Máquinas virtuales (cómo servicio)](#Mquinasvirtualescmoservicio)
	* 3.2. [Contenedores](#Contenedores)
	* 3.3. [Serverless](#Serverless)
	* 3.4. [Infraestructura tradicional](#Infraestructuratradicional)
	* 3.5. [Infraestructura como servicio](#Infraestructuracomoservicio)
	* 3.6. [Plataforma como servicio](#Plataformacomoservicio)
	* 3.7. [Software como servicio](#Softwarecomoservicio)
	* 3.8. [Storage como servicio](#Storagecomoservicio)
	* 3.9. [Network como servicio](#Networkcomoservicio)
	* 3.10. [Comunication como servicio](#Comunicationcomoservicio)
	* 3.11. [CapEx y OpEx](#CapExyOpEx)
* 4. [Formas de implementar la nube](#Formasdeimplementarlanube)
	* 4.1. [Nube pública](#Nubepblica)
	* 4.2. [Nube privada](#Nubeprivada)
	* 4.3. [Nube híbrida](#Nubehbrida)
* 5. [Azure y sus servicios](#Azureysusservicios)
	* 5.1. [Servicios de cómputo](#Serviciosdecmputo)
	* 5.2. [Servicios de redes](#Serviciosderedes)
	* 5.3. [Servicios de almacenamiento](#Serviciosdealmacenamiento)
	* 5.4. [Servicios de bases de datos](#Serviciosdebasesdedatos)
	* 5.5. [Servicios Web](#ServiciosWeb)
	* 5.6. [Servicios de IoT y Big Data](#ServiciosdeIoTyBigData)
	* 5.7. [Servicios de Inteligencia Artificial y DevOps](#ServiciosdeInteligenciaArtificialyDevOps)
	* 5.8. [Servicios cognitivos](#Servicioscognitivos)
	* 5.9. [Grupo de recursos](#Grupoderecursos)
	* 5.10. [Azure resource manager](#Azureresourcemanager)
	* 5.11. [Etiquetas de servicios](#Etiquetasdeservicios)
* 6. [Servicios de almacenamiento de datos y recursos en Azure](#ServiciosdealmacenamientodedatosyrecursosenAzure)
* 7. [Infraestructura de Azure](#InfraestructuradeAzure)
	* 7.1. [Distribución de centro de datos y regiones en Azure](#DistribucindecentrodedatosyregionesenAzure)
	* 7.2. [Geografía en servicios de Azure](#GeografaenserviciosdeAzure)
	* 7.3. [Zonas de disponibilidad en Azure](#ZonasdedisponibilidadenAzure)
	* 7.4. [Regiones pares](#Regionespares)
* 8. [Concepto de Redes de Azure](#ConceptodeRedesdeAzure)
	* 8.1. [Red Virtual Azure](#RedVirtualAzure)
	* 8.2. [Disponibilidad y resiliencia de las redes en Azure](#DisponibilidadyresilienciadelasredesenAzure)
	* 8.3. [Azure DNS](#AzureDNS)
	* 8.4. [Equilibrador de carga](#Equilibradordecarga)
	* 8.5. [CDN de Azure](#CDNdeAzure)
* 9. [Seguridad en redes de Azure](#SeguridadenredesdeAzure)
	* 9.1. [Grupos de seguridad en redes de Azure](#GruposdeseguridadenredesdeAzure)
	* 9.2. [Gestor de tráfico en Azure](#GestordetrficoenAzure)
	* 9.3. [Traffic Manager vs Load Balancer](#TrafficManagervsLoadBalancer)
	* 9.4. [Azure Application Gateway](#AzureApplicationGateway)
	* 9.5. [Azure Front Door](#AzureFrontDoor)
* 10. [Seguridad en Azure](#SeguridadenAzure)
	* 10.1. [Responsabilidad compartida](#Responsabilidadcompartida)
	* 10.2. [Identidad de Azure](#IdentidaddeAzure)
	* 10.3. [Azure Security Center](#AzureSecurityCenter)
	* 10.4. [Cifrado en Azure](#CifradoenAzure)
	* 10.5. [Certificados](#Certificados)
	* 10.6. [Protección de información y Advance Threat Protection](#ProteccindeinformacinyAdvanceThreatProtection)
* 11. [Políticas de Azure,Seguridad y Gobernanza de Azure](#PolticasdeAzureSeguridadyGobernanzadeAzure)
	* 11.1. [Declaración de privacidad](#Declaracindeprivacidad)
	* 11.2. [Microsoft Trust Center](#MicrosoftTrustCenter)
	* 11.3. [Azure Policy](#AzurePolicy)
	* 11.4. [Gobernanza de suscripción](#Gobernanzadesuscripcin)
	* 11.5. [Azure Blueprint](#AzureBlueprint)
	* 11.6. [Compliance Manager](#ComplianceManager)
	* 11.7. [Compliance Manager y Service Healt](#ComplianceManageryServiceHealt)
* 12. [Costos en Azure](#CostosenAzure)
	* 12.1. [Factores de costos](#Factoresdecostos)
	* 12.2. [Azure Advisor](#AzureAdvisor)
	* 12.3. [Ahorro de costos](#Ahorrodecostos)
* 13. [Acuerdos de nivel de servicio en Azure](#AcuerdosdeniveldeservicioenAzure)
	* 13.1. [SLA de Azure](#SLAdeAzure)
	* 13.2. [SLA de aplicación](#SLAdeaplicacin)
...
##  3. <a name='Cmputoenlanube'></a>Cómputo en la nube
...
###  3.1. <a name='Mquinasvirtualescmoservicio'></a>Máquinas virtuales (cómo servicio)
...
###  3.2. <a name='Contenedores'></a>Contenedores
...
###  3.3. <a name='Serverless'></a>Serverless
...
###  3.4. <a name='Infraestructuratradicional'></a>Infraestructura tradicional
...
###  3.5. <a name='Infraestructuracomoservicio'></a>Infraestructura como servicio
...
###  3.6. <a name='Plataformacomoservicio'></a>Plataforma como servicio
`Servicio que nos permite desarrollar sistemas y ejecutar sus propios programas y aplicaciones en distintos lenguajes`

###  3.7. <a name='Softwarecomoservicio'></a>Software como servicio
`Provee aplicaciones para ser consumido por el usuario`

###  3.8. <a name='Storagecomoservicio'></a>Storage como servicio
`Provee de una infraestructura de almacenamiento`

###  3.9. <a name='Networkcomoservicio'></a>Network como servicio
...
##  4. <a name='Formasdeimplementarlanube'></a>Formas de implementar la nube

###  4.1. <a name='Nubepblica'></a>Nube pública
...
##  5. <a name='Azureysusservicios'></a>Azure y sus servicios
...
- Administración
- CDN
###  5.1. <a name='Serviciosdecmputo'></a>Servicios de cómputo
...
###  5.2. <a name='Serviciosderedes'></a>Servicios de redes
...
###  5.3. <a name='Serviciosdealmacenamiento'></a>Servicios de almacenamiento
...
###  5.4. <a name='Serviciosdebasesdedatos'></a>Servicios de bases de datos
...
###  5.5. <a name='ServiciosWeb'></a>Servicios Web
...
###  5.6. <a name='ServiciosdeIoTyBigData'></a>Servicios de IoT y Big Data
...
###  5.7. <a name='ServiciosdeInteligenciaArtificialyDevOps'></a>Servicios de Inteligencia Artificial y DevOps
...
###  5.8. <a name='Servicioscognitivos'></a>Servicios cognitivos
...
###  5.9. <a name='Grupoderecursos'></a>Grupo de recursos
...
###  5.10. <a name='Azureresourcemanager'></a>Azure resource manager
...
###  5.11. <a name='Etiquetasdeservicios'></a>Etiquetas de servicios
Son nombres y valores de datos para asociar detalles entre nuestros recursos. Un recurso puede tener hasta 50 etiquetas
##  6. <a name='ServiciosdealmacenamientodedatosyrecursosenAzure'></a>Servicios de almacenamiento de datos y recursos en Azure
...
##  7. <a name='InfraestructuradeAzure'></a>Infraestructura de Azure 
###  7.1. <a name='DistribucindecentrodedatosyregionesenAzure'></a>Distribución de centro de datos y regiones en Azure
...
###  7.2. <a name='GeografaenserviciosdeAzure'></a>Geografía en servicios de Azure
...
###  7.3. <a name='ZonasdedisponibilidadenAzure'></a>Zonas de disponibilidad en Azure
Centro físico que se encuentra dentro de una región
###  7.4. <a name='Regionespares'></a>Regiones pares
Centros físicos alejados pero que se encuentran dentro de una misma región.
##  8. <a name='ConceptodeRedesdeAzure'></a>Concepto de Redes de Azure
###  8.1. <a name='RedVirtualAzure'></a>Red Virtual Azure 
...
###  8.2. <a name='DisponibilidadyresilienciadelasredesenAzure'></a>Disponibilidad y resiliencia de las redes en Azure
| Tipo           | Descripción                                                                |
| -------------- | -------------------------------------------------------------------------- |
...
###  8.3. <a name='AzureDNS'></a>Azure DNS
...
###  8.4. <a name='Equilibradordecarga'></a>Equilibrador de carga
...
###  8.5. <a name='CDNdeAzure'></a>CDN de Azure
...
##  9. <a name='SeguridadenredesdeAzure'></a>Seguridad en redes de Azure
###  9.1. <a name='GruposdeseguridadenredesdeAzure'></a>Grupos de seguridad en redes de Azure
...
###  9.2. <a name='GestordetrficoenAzure'></a>Gestor de tráfico en Azure
...
###  9.3. <a name='TrafficManagervsLoadBalancer'></a>Traffic Manager vs Load Balancer
...
###  9.4. <a name='AzureApplicationGateway'></a>Azure Application Gateway
...
###  9.5. <a name='AzureFrontDoor'></a>Azure Front Door
...
- Seguridad en linea
##  10. <a name='SeguridadenAzure'></a>Seguridad en Azure
###  10.1. <a name='Responsabilidadcompartida'></a>Responsabilidad compartida
Es la asignatura de responsabilidad entre proveedor y cliente.
###  10.2. <a name='IdentidaddeAzure'></a>Identidad de Azure
...
###  10.3. <a name='AzureSecurityCenter'></a>Azure Security Center
...
###  10.4. <a name='CifradoenAzure'></a>Cifrado en Azure
...
###  10.5. <a name='Certificados'></a>Certificados
...
###  10.6. <a name='ProteccindeinformacinyAdvanceThreatProtection'></a>Protección de información y Advance Threat Protection
...
##  11. <a name='PolticasdeAzureSeguridadyGobernanzadeAzure'></a>Políticas de Azure,Seguridad y Gobernanza de Azure
###  11.1. <a name='Declaracindeprivacidad'></a>Declaración de privacidad
...
###  11.2. <a name='MicrosoftTrustCenter'></a>Microsoft Trust Center
...
###  11.3. <a name='AzurePolicy'></a>Azure Policy
...
###  11.4. <a name='Gobernanzadesuscripcin'></a>Gobernanza de suscripción
...
###  11.5. <a name='AzureBlueprint'></a>Azure Blueprint
...
###  11.6. <a name='ComplianceManager'></a>Compliance Manager
...
###  11.7. <a name='ComplianceManageryServiceHealt'></a>Compliance Manager y Service Healt
...
##  12. <a name='CostosenAzure'></a>Costos en Azure
###  12.1. <a name='Factoresdecostos'></a>Factores de costos
Costos que podría afectar al implementar los servicios de Azure
**Ubicación**, **Tipo de recurso**, **Tipos de suscripción**

###  12.2. <a name='AzureAdvisor'></a>Azure Advisor
Busca la manera de mejorar el ambiente en tus servicios

###  12.3. <a name='Ahorrodecostos'></a>Ahorro de costos
...
****
##  13. <a name='AcuerdosdeniveldeservicioenAzure'></a>Acuerdos de nivel de servicio en Azure
...
###  13.1. <a name='SLAdeAzure'></a>SLA de Azure 
...
###  13.2. <a name='SLAdeaplicacin'></a>SLA de aplicación
...
##  14. <a name='Preguntas'></a>Preguntas
